    ...
    <>
      <section>
        <div className="flex justify-between max-w-[1500px] my-12 mx-auto">
          <div className="p-5 border-1 flex flex-col justify-center border-gray-300 w-[68%] rounded-md mx-auto relative">
            <p className="text-[#444444] text-[18px] font-semibold gap-4 flex absolute top-5 left-5">
              <span> 1</span> <span>Personal Information</span>
            </p>
            <p className="flex gap-3 absolute top-20 left-20">
              <span>
